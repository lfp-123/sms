...
<form class="layui-form" action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input style="width:500px;" type="password" name="password" id="password" placeholder="请输入新密码"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">新密码</label>
        <div class="layui-input-block">
            <input style="width:500px;" type="password" name="qrpassword" id="qrpassword" placeholder="请输入确认新密码"
                   class="layui-input">
        </div>
    </div>
    <input style="width:500px;" type="hidden" value="${sessionScope.currentUser.id}" name="id" id="id"
