            ...
            if (obj.event === 'del') {
                ...
                layer.open({
                    ...
                    , yes: function () {
                        ...
                        $.post("${pageContext.request.contextPath}/supplier/update.do", {
                            id: id,
                            address: address,
                            contact: contact,
                            name: name,
            ...
            offset: function (othis) {
                ...
                layer.open({
                    ...
                    , yes: function () {
                        ...
                        $.post("${pageContext.request.contextPath}/supplier/add.do", {
                            address: address,
                            contact: contact,
                            name: name,
                            number: number,
...
<form class="layui-form" id="add" action="" style="display:none;padding-left: 10%">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="contact" id="contact" style="width: 350px;" lay-verify="title" autocomplete="off"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" id="name" style="width: 350px;" lay-verify="title" autocomplete="off"
                   placeholder="请输入供应商" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="remarks" id="remarks" style="width: 350px;" lay-verify="title" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
</form>
